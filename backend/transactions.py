...
def _execute_transfer(
    ...
    # Verify PIN (required for transfers and other actions)
    pw_row = conn.execute(
    ...
    # Receiver wallet (lookup by phone)
    ...
    # Award points to sender and update tier
            ...
            if sys_user:
                conn.execute(
                    text("""
                        ...
                        VALUES (:uid, 'BILL_SYSTEM', 0.00, true)
