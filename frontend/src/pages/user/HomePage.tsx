        ...
        <Card className="md:col-span-2 relative flex flex-col justify-between overflow-hidden group min-h-[160px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="p-1.5 rounded-full hover:bg-[var(--bg-secondary)] text-[var(--text-secondary)] hover:text-white transition-all outline-none"
          ...
          <div className="my-3 flex flex-col gap-1 select-none">
            {showBalance ? (
              <h2 className="font-sora font-extrabold text-3xl text-white tracking-tight leading-none">
                {formatBDT(user?.balance ?? 100000.00)}
              </h2>
            ) : (
              <h2 className="font-sora font-extrabold text-3xl text-white tracking-widest leading-none">
                ৳ ••••••••
              </h2>
            )}
            <p className="text-[10px] text-[var(--text-secondary)] font-mono tracking-wide mt-1">
              Wallet Account ID: <span className="text-[var(--text-primary)]">{user?.wallet_number || 'PG-WAL-00001'}</span>
            </p>
          </div>
